...
interface BordbestillingPageContentProps {
  openingHoursSummary: string
}

export function BordbestillingPageContent({ openingHoursSummary }: BordbestillingPageContentProps) {
  const {
    register,
    handleSubmit,
    control,
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 rounded-lg border border-white/10 bg-black/40 backdrop-blur-sm p-6 text-center">
          <p className="text-gray-400 text-sm">
            Vi har åpent <span className="text-white font-medium">{openingHoursSummary}</span>.
